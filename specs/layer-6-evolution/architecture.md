...
| ARCH-AMEND-002 | architecture.md | 2026-07-13 | Baseline v1.1: Reference runtime declared conformant with Architecture v1.0. All four Architecture Conformance Defects (ACD-001..ACD-004) resolved and closed by executable conformance tests in `tests/conformance/`. Architecture v1.0 remains frozen; this amendment records the conformant reference-runtime milestone (v1.1) and does not alter any architectural constraint. The permanent Architecture Conformance Report is regenerated by `tools/generate_conformance_report.py` and committed as `docs/conformance-report.md`. | No |