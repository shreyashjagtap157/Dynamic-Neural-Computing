...
| INTENT-007 | Detect semantic saturation and answer novelty | Master plan Phase 5; `src/dnc/assurance/semantic.py` | Correlation-aware semantic cluster records | Cluster tests discount correlated agreement and preserve minority conclusions |
