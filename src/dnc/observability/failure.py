...
class FailureClassifier:
    ...
    def __init__(self) -> None:
        ...
        self._total_invocations: Dict[str, int] = {}
    ...
    def record_failure(
        ...
        total = self._total_invocations.get(key, 0) + total_invocations
        self._total_invocations[key] = total
        if total > 0:
            self._module_failure_rates[key] = failures / total
